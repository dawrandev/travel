            ...
            <form id="editBannerForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">Оставьте пустым, если не хотите менять изображение. Рекомендуемый размер: 1920x600px. Макс. 5MB</small>
                    </div>
...
<script>
    ...
    function populateEditBannerModal(response) {
        try {
            ...
            // Form action
            $('#editBannerForm').attr('action', '/abouts/banner/' + banner.id);
