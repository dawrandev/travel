<div class="modal fade" id="createBannerModal" tabindex="-1" role="dialog" aria-labelledby="createBannerModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('abouts.banner.store') }}" method="POST" enctype="multipart/form-data" id="createBannerForm">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">Рекомендуемый размер: 1920x600px. Макс. 5MB</small>
                    </div>
